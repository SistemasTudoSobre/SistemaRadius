...
const
  ...
  RADIUS_SUB_DOMINIO = 'http://demo.nrgthemes.com/projects/nrghostwp/';
  // PROTOCOLO + 'radius.' + DOMINIO;
  RADIUS_URL_ATUALIZACAO = RADIUS_SUB_DOMINIO + '/' + 'atualizacao';
  RADIUS_ARQUIVO_WEB_ATUALIZACAO = 'atualizacao.php';
  RADIUS_WEB_SERVICE_ATUALIZACAO = RADIUS_URL_ATUALIZACAO + '/' +
    RADIUS_ARQUIVO_WEB_ATUALIZACAO;
  RADIUS_URL_SUPORTE = RADIUS_SUB_DOMINIO + '/' + 'suporte';
  RADIUS_ARQUIVO_WEB_SUPORTE = 'suporte.php';
  RADIUS_WEB_SERVICE_SUPORTE = RADIUS_URL_SUPORTE + '/' +
    RADIUS_ARQUIVO_WEB_SUPORTE;
  RADIUS_BUILD = 'Radius';
